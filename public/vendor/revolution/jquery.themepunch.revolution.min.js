            ...
            jQuery(this).on("scriptsloaded", function () {
              if (a.modulesfailing)
                return (
                  b
                    .html(
                      '<div style="margin:auto;line-height:40px;font-size:14px;color:white;padding:15px;background:#e74c3c;margin:20px 0px;">!! Error at loading Slider Revolution 5.0 Extrensions.' +
                        a.errorm +
                        "</div>"
                    )
                    .show(),
      ...
      a.find("img,.defaultimg, .tp-svg-layer").each(function () {
        ...
        if (
          ...
          "https:" === location.protocol &&
            ...
            console.error(i),
            b.c.append(
              '<div style="position:absolute;top:50%;width:100%;color:#e74c3c;  font-size:16px; text-align:center; padding:15px;background:var(--black); display:block;"><strong>' +
                i +
                "</strong></div>"
            );
        }
