...
export const BlogDetail = ({ facebookPostDetail, facebookPosts }: { facebookPostDetail: FacebookPost, facebookPosts: FacebookPost[] }) => {
  const [ animation, setAnimation ] = useState<boolean>(false);
  const [ relatedPosts, setRelatedPosts ] = useState<FacebookPost[]>()

  function relatedPostSetter() {
    if (facebookPosts?.length) {
      const filteredPosts = facebookPosts.filter((post: FacebookPost)=> post !== facebookPostDetail)
  ...
  return (
          <section className={`blog-detail ${animation ? 'animate__animated animate__fadeIn' : ''} pt-0`}>
            <div className="container">
              <div className="row pt-0">
                <div className="col-lg-8 col-md-7">
                  <div className="blog-thumb justify-content-center mt-2" >
                    <img alt="facebook-post-image" src={facebookPostDetail.image.src} />
                  </div>
                  ...
                  <div className="blog-content">
                    ...
                    <div className='col-12 mt-5'>
                      <span className="d-flex justify-content-end">
                        <a href={facebookPostDetail.url} style={{ color: '#e91d25' }} target='_blank'>Ver publicación en Facebook</a>
                      </span>
                    </div>
                ...
                <div className="col-lg-4 col-md-5">
                  ...
                  <div className='col-12 mt-5'>
                    <Link href={`/${PAGES_PATH.NEWS_PATH}`} className="au-btn au-btn--pill au-btn--yellow au-btn--medium" style={{ color: 'white' }}>Volver a todas las noticias</Link>
                  </div>
                </div>
              </div>
            </div>
